...
class user extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('username, user_email', 'required'),
                        array('user_email', 'email'),
			array('user_role_user_role_id', 'numerical', 'integerOnly'=>true),
			array('username, user_avatar', 'length', 'max'=>127),
	...
	public function relations()
	{
		...
		return array(
			...
			'userRoleUserRole' => array(self::BELONGS_TO, 'UserRole', 'user_role_user_role_id'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'user_role_user_role_id' => 'User Role User Role',
		);
	}
